...
<#
.SYNOPSIS
    Creates a complete inventory of a Citrix NetScaler MAS configuration using Microsoft Word.
.DESCRIPTION
	Creates a complete inventory of a Citrix NetScaler MAS configuration using Microsoft Word and PowerShell.
	Creates a Word document named "NetScaler MAS Docuemntation".
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1
	
	Will use all default values.
	HKEY_CURRENT_USER\Software\Microsoft\Office\Common\UserInfo\CompanyName="Andrew McCullough" or
	HKEY_CURRENT_USER\Software\Microsoft\Office\Common\UserInfo\Company="Andrew McCullough"
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -PDF
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript .\NetScaler_MAS_Script_v1_0.ps1 -CompanyName "Andrew McCullough Consulting" -CoverPage "Mod" -UserName "Andrew McCullough"
...
.EXAMPLE
	PS C:\PSScript .\NetScaler_MAS_Script_v1_0.ps1 -CN "Andrew McCullough Consulting" -CP "Mod" -UN "Andrew McCullough"
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -PDF -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -Folder \\FileServer\ShareName
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -SmtpServer mail.domain.tld -From XDAdmin@domain.tld -To ITGroup@domain.tld
...
.EXAMPLE
	PS C:\PSScript > .\NetScaler_MAS_Script_v1_0.ps1 -SmtpServer smtp.office365.com -SmtpPort 587 -UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com
...
.NOTES
	NAME: NetScaler_MAS_Script_v1_0.ps1
	VERSION: 1.01
...
Param(
	...
	## EXPERIMENTAL: Require SSL/TLS, e.g. https://. This requires the client to trust to the NetScaler MAS certificate.
    [parameter(Mandatory=$false )]
...
{
	$Error.Clear()
	$Script:DevErrorFile = "$($pwd.Path)\NSMASInventoryScriptErrors_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
}
...
Function ProcessScriptEnd
{
	...
	If($ScriptInfo)
	{
		$SIFile = "$($pwd.Path)\NSMASInventoryScriptInfo_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
...
[System.Collections.Hashtable[]] $nmasruleh = @(
    ...
    @{ Description = "Instances"; Value = $nmasrule.criteria.source ;}
    @{ Description = "Category"; Value = $nmasrule.criteria.category ;}
...
[System.Collections.Hashtable[]] $nmassbh = @(
    @{ Description = "Description"; Value = $Stylebook.description ;}
...
WriteWordLine 0 0 " "
WriteWordLine 0 0 $StylebookInfo.source
WriteWordLine 0 0 " "
