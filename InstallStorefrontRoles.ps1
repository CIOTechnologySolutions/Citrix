#==========================================================================
#
# Installation of Microsoft Roles and Features for Citrix StoreFront
#
...
#
# Please note that the following prerequisite roles for Citrix StoreFront are
# installed automatically during the installation of Citrix StoreFront:
#   -Internet Information Service (IIS)
#   -Remote Assistance (if you need the shadow feature)
#
...
$PackageName = "Citrix StoreFront Roles"               # [edit] enter the display name of the software (e.g. 'Arcobat Reader' or 'Microsoft Office')
